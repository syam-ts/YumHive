...
const About = () => {
    return (<div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex flex-col lg:flex-row justify-between gap-8 p-44">
                ...
                <div className="w-full lg:w-8/12 ">
                    <img className="w-full h-full rounded-xl" src="https://exotel.com/wp-content/uploads/2023/04/home-page-images-Swiggy-scaled.jpg" alt="A group of People"/>
                </div>
            </div>
