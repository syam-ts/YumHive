      ...
      {cart.length > 0 ? (
        <div>
          ...
          <div className="flex gap-96 justify-center">
            ...
            <div>
              <Link to="/checkout">
                <button className=" items-center justify-center px-2 py-3 text-sm font-bold leading-6 capitalize duration-100 transform border-2 rounded-sm cursor-pointer border-sky-500 focus:ring-4 focus:ring-green-500 focus:ring-opacity-50 focus:outline-none sm:w-auto sm:px-6 border-text  hover:shadow-lg hover:-translate-y-1">
                  Checkout
                </button>
              </Link>
            </div>
