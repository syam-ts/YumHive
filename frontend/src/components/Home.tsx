...
const Home = () => {
  ...
  const navigate = useNavigate() 
      ...
      return (
      <div>
        <div className="w-full h-[650px] overflow-x-hidden overflow-hidden relative">
          <img src="https://img.freepik.com/premium-photo/large-table-chinese-new-years-eve-dinner-spread_1316316-16632.jpg?w=1380" className="absolute top-0 left-0 min-h-full w-full" alt="" />
          <div className="relative z-20 max-w-screen-lg mx-auto grid grid-cols-12 h-full items-center">
            <div className="col-span-6">
              ...
              <button className="mt-8 text-white uppercase py-1 text-base font-light px-10 border border-white hover:bg-white hover:bg-opacity-50 hover:text-black"> 
